...
const { protect, restrictTo } = require('../middleware/auth'); // Adjust path if needed
...
// Activity tracking
router.post('/activity', protect, trackActivity); // POST /api/users/activity - Track activity (note: moved to /activity for clarity)
